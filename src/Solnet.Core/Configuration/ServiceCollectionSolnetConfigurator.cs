...
{
    public class ServiceCollectionSolnetConfigurator :
        RegistrationConfigurator,
        IBusRegistrationConfigurator
    {
        //public ServiceCollectionSolnetConfigurator(IServiceCollection collection)
        ...
        //protected ServiceCollectionSolnetConfigurator(IServiceCollection collection, IContainerRegistrar registrar)
    ...
    public class ServiceCollectionBusConfigurator<TBus, TBusInstance> :
        ServiceCollectionSolnetConfigurator,
