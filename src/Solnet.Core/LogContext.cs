...
namespace Solnet.Core
{
    public static class LogContext
    {
        ...
        {
            Current = new SolnetLogContext(loggerFactory ?? NullLoggerFactory.Instance);
        }
        ...
        {
            Current = new SolnetLogContext(new SingleLoggerFactory(logger));
        }
        ...
        static ILogContext CreateDefaultLogContext()
        {
            ...
            return new SolnetLogContext(loggerFactory);
        }
    }
}
