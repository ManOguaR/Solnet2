...
//            var meter = meterFactory.Create(new MeterOptions(InstrumentationOptions.MeterName) { Version = HostMetadataCache.Host.SolnetCoreVersion });
...
//        }
        ...
        public static void TryConfigure(InstrumentationOptions options)
        {
            ...
            Configure(new Meter(InstrumentationOptions.MeterName, HostMetadataCache.Host.SolnetCoreVersion), options);
        }
        ...
        //    {
        //        if (type.StartsWith("SolnetCore.MessageHandler<"))
        //            return "Handler";
